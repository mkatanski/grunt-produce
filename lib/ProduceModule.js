...
var ProduceModule = (function () {
  ...
  ProduceModule.prototype.getQuestions = function () {
    ...
    _.each(this.locals, function (value, varName) {
      // create new question object and append to list
      _questions.push({
        name:    varName,
        message: varName,
        default: value
  ...
  ProduceModule.prototype._prepareVariables = function () {
    ...
    if (_.isObject(this.template.variables)) {
      ...
      _.each(this.template.variables, function (value, varName) {
        ...
        this.locals[varName] = this.grunt.option(varName) || value.default;
      }, this);
    }
